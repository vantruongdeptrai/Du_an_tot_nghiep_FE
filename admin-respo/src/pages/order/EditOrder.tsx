                ...
                <div className="dark:bg-blackPrimary bg-whiteSecondary py-10">
                    <div className="px-4 sm:px-6 lg:px-8 pb-8 border-b border-gray-800 flex justify-between items-center max-sm:flex-col max-sm:gap-5">
                        ...
                        <div className="flex gap-x-2 max-[370px]:flex-col max-[370px]:gap-2 max-[370px]:items-center">
                            ...
                            <WhiteButton link="/orders/add-order" textSize="lg" width="48" py="2" text="Update order">
                            ...
                            <div className="mt-4 flex flex-col gap-5">
                                <InputWithLabel label="Customer name">
                                    <SimpleInput
                                        ...
                                        onChange={(e) =>
                                            setInputObject({ ...inputObject, customerName: e.target.value })
                                        }
                                    />
                                </InputWithLabel>
                                ...
                                <InputWithLabel label="Customer lastname">
                                    <SimpleInput
                                        ...
                                        onChange={(e) =>
                                            setInputObject({ ...inputObject, customerLastName: e.target.value })
                                        }
                                    />
                                </InputWithLabel>
                                ...
                                <InputWithLabel label="Country">
                                    <SimpleInput
                                        ...
                                        onChange={(e) => setInputObject({ ...inputObject, country: e.target.value })}
                                    />
                                </InputWithLabel>
                                ...
                                <InputWithLabel label="Street and house number">
                                    <SimpleInput
                                        ...
                                        onChange={(e) =>
                                            setInputObject({ ...inputObject, streetAndHouseNumber: e.target.value })
                                        }
                                    />
                                </InputWithLabel>
                                ...
                                <InputWithLabel label="City">
                                    <SimpleInput
                                        ...
                                        onChange={(e) => setInputObject({ ...inputObject, city: e.target.value })}
                                    />
                                </InputWithLabel>
                                ...
                                <InputWithLabel label="Zip code">
                                    <SimpleInput
                                        ...
                                        onChange={(e) => setInputObject({ ...inputObject, zipCode: e.target.value })}
                                    />
                                </InputWithLabel>
                                ...
                                <InputWithLabel label="Phone number">
                                    <SimpleInput
                                        ...
                                        onChange={(e) =>
                                            setInputObject({ ...inputObject, phoneNumber: e.target.value })
                                        }
                                    />
                                </InputWithLabel>
                                ...
                                <InputWithLabel label="Email address">
                                    <SimpleInput
                                        ...
                                        onChange={(e) =>
                                            setInputObject({ ...inputObject, emailAddress: e.target.value })
                                        }
                                    />
                                </InputWithLabel>
                                ...
                                <InputWithLabel label="Order notice">
                                    <TextAreaInput
                                        ...
                                        onChange={(e) =>
                                            setInputObject({ ...inputObject, orderNotice: e.target.value })
                                        }
                                    />
                                </InputWithLabel>
                            </div>
                                ...
                                <div className="mt-4 flex flex-col gap-5">
                                    <InputWithLabel label="Search products">
                                        <SimpleInput
                                            ...
                                            onChange={(e) =>
                                                setInputObject({ ...inputObject, searchProducts: e.target.value })
                                            }
                                        />
                                    </InputWithLabel>
                                    <InputWithLabel label="Quantity">
                                        <SimpleInput
                                            ...
                                            onChange={(e) =>
                                                setInputObject({ ...inputObject, quantity: Number(e.target.value) })
                                            }
                                        />
                                    </InputWithLabel>
                                    <WhiteButton
