...
import { ImageUpload, InputWithLabel, Sidebar, SimpleInput, WhiteButton, TextAreaInput } from "../../components";
                ...
                <div className="dark:bg-blackPrimary bg-whiteSecondary py-10">
                    <div className="px-4 sm:px-6 lg:px-8 pb-8 border-b border-gray-800 flex justify-between items-center max-sm:flex-col max-sm:gap-5">
                        ...
                        <div className="flex gap-x-2 max-[370px]:flex-col max-[370px]:gap-2 max-[370px]:items-center">
                            ...
                            <WhiteButton link="/reviews" textSize="lg" width="48" py="2" text="Update review">
                    ...
                    <div className="px-4 sm:px-6 lg:px-8 pb-8 pt-8 grid grid-cols-2 gap-x-10 max-xl:grid-cols-1 max-xl:gap-y-10">
                        ...
                        <div>
                            ...
                            <div className="flex justify-center gap-x-2 mt-5 flex-wrap">
                                <img src="/src/assets/phone 1.jpg" alt="" className="w-36 h-32" />
                            </div>
                        </div>
                    </div>
                </div>
