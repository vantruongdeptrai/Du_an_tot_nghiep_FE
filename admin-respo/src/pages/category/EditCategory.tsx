...
const EditCategory = () => {
  ...
  const { updateCategory } = useCategory(); // Đảm bảo hàm updateCategory được destructured đúng cách
  ...
  const onSubmit: SubmitHandler<categoryInput> = async (data) => {
    try {
      ...
      console.error("Cập nhật danh mục không thành công", error);
      // Hiển thị thông báo lỗi hoặc xử lý lỗi nếu cần
    }
  };
